...
//    订单总金额
    ...
    buyerOrderDto.setOrderId(orderId);
    buyerOrderDto.setOrderAmount(orderAmount);
    buyerOrderDto.setOrderStatus(OrderStatusEnum.NEW.getCode());
    buyerOrderDto.setPayStatus(PayStatusEnum.WAIT.getCode());
